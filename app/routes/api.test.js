...
describe('GET /api', () => {
	it('responds with json for /api', (done) => {
		supertest(app).get('/api').set('Accept', 'application/json').expect('Content-Type', /json/).expect(200, done);
	});
});

describe('GET /api/ping', () => {
	it('responds with json for /api/ping', (done) => {
		supertest(app)
			.get('/api/ping')
...
describe('GET /api/posts?tags=tech', () => {
	it('responds with json for /api/posts?tags=tech', (done) => {
		supertest(app)
...
describe('GET /api/posts?tags=tech&sortBy=likes', () => {
	it('responds with json for /api/posts?tags=tech&sortBy=likes', (done) => {
		supertest(app)
...
describe('GET /api/posts?tags=tech&direction=desc', () => {
	it('responds with json for /api/posts?tags=tech&direction=desc', (done) => {
		supertest(app)
...
describe('GET /api/posts?tags=tech&sortBy=invalid', () => {
	it('responds with json for /api/posts?tags=tech&sortBy=invalid', (done) => {
		supertest(app)
...
describe('GET /api/posts?tags=tech&direction=invalid', () => {
	it('responds with json for /api/posts?tags=tech&direction=invalid', (done) => {
		supertest(app)
			.get('/api/posts?tags=tech&direction=invalid')
			.set('Accept', 'application/json')
			.expect('Content-Type', /json/)
			.expect(400, done);
	});
});
describe('GET /api/posts?tags=invalid', () => {
	it('responds with json for /api/posts?tags=invalid', (done) => {
		supertest(app)
			.get('/api/posts?tags=invalid')
			.set('Accept', 'application/json')
			.expect('Content-Type', /json/)
			.expect(200, done);
	});
...
describe('GET /api/posts', () => {
	it('responds with json for /api/posts', (done) => {
		supertest(app)
			.get('/api/posts')
			.set('Accept', 'application/json')
			.expect('Content-Type', /json/)
